...
contextBridge.exposeInMainWorld('api', {
    ...
    triggerGoogleLogin: () => ipcRenderer.invoke('google-login'),
    googleLogout: () => ipcRenderer.invoke('google-logout'),
    googleGetStatus: () => ipcRenderer.invoke('google-get-status'),
    googleSyncUpload: () => ipcRenderer.invoke('google-sync-upload'),
    ...
    getAutoLaunchGateway: () => ipcRenderer.invoke('auto-launch-gateway-get'),
    setAutoLaunchGateway: (enabled) => ipcRenderer.invoke('auto-launch-gateway-set', enabled),
    pickCustomThemeBackground: () => ipcRenderer.invoke('theme-pick-background'),
    getCustomThemeBackground: () => ipcRenderer.invoke('theme-get-background'),
    clearCustomThemeBackground: () => ipcRenderer.invoke('theme-clear-background'),
    ...
    onGoogleLoginSuccess: (callback) => ipcRenderer.on('google-login-success', (event, data) => callback(data)),
    onGoogleLoginFailed: (callback) => ipcRenderer.on('google-login-failed', (event, data) => callback(data)),
